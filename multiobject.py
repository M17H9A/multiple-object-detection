...
w = tk.Label(root, text = "IMAGE-DETECTION", font = "Arial 25", bg ='lightgray', width = 900)
w.pack()
button = tk.Button(root, text = "CHOOSE", font = "Arial24", command = search_image)
button.pack()
root.mainloop()
